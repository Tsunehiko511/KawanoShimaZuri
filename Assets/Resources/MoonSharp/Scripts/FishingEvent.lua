function main()
    ...
    message.ShowMessage("勇者「食べちゃお！いただきまーす")
    coroutine.yield()
    ...
    coroutine.yield()
    message.ShowMessage("姫様「え〜ん... もう寝る！")
    ...
    coroutine.yield()
    message.ShowMessage("王様「まだ実験段階なんだが\n これを使うとシママスが釣れやすくなるようじゃ")
    coroutine.yield()
    message.ShowMessage("王様「世に出回るとシママスの数も減ってしまう\n から秘密にしておったんじゃが")
    coroutine.yield()
    message.ShowMessage("王様「これで何とか釣ってきてはどうか？")
    coroutine.yield()
    message.ShowMessage("勇者「え！いいんですか？")
    coroutine.yield()
    message.ShowMessage("王様「今回は仕方がない\n 博士によると家の前の川でも釣れるらしいぞ")
    coroutine.yield()
    message.ShowMessage("勇者「ありがとうございます！\n さっそく試してきます")
    coroutine.yield()
    ...
    coroutine.yield()
    message.ShowMessage("王様「勇者よ まだ釣り方を知らんじゃろ\n 魚が止まっているときにSPACEじゃよ！")
    coroutine.yield()
    message.ShowMessage("勇者「ありがとうございます！")
    ...
    message.ShowMessage("勇者「よーーし 釣るぞ！！！")
    coroutine.yield()
    fishing()
    coroutine.yield()
    ...
    coroutine.yield()
    player.Look("down")
    message.ShowMessage("姫様「なによ〜！もぅ寝てたのに！")
    ...
    message.ShowMessage("姫様「あ〜楽しみ♪楽しみ♪")
    coroutine.yield()
    ...
    coroutine.yield()
    message.ShowMessage("勇者「はい！家の宝箱で手に入れました！")
    coroutine.yield()
